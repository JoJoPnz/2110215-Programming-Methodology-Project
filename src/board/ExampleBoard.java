...
public class ExampleBoard extends Application { 
   ...
   public void start(Stage stage) { 
	  ...
	  Square square3 = new PropertySquare("เรารักในหลวง3",area,100);
	  Square square4 = new PropertySquare("เรารักในหลวง4",area,100);
	  Square square5 = new PropertySquare("เรารักในหลวง5",area,100);
	  Square square6 = new PropertySquare("เรารักในหลวง6",area,100);
	  Square square7 = new PropertySquare("เรารักในหลวง7",area,100);
	  
	  
	  Square square8 = new JailSquare();
	  Square square9 = new PropertySquare("เรารักในหลวง1",area,100);
	  Square square10 = new PropertySquare("เรารักในหลวง2",area,100);
	  Square square11 = new PropertySquare("เรารักในหลวง3",area,100);
	  Square square12 = new PropertySquare("เรารักในหลวง4",area,100);
	  Square square13 = new PropertySquare("เรารักในหลวง5",area,100);
	  Square square14 = new PropertySquare("เรารักในหลวง6",area,100);
	  ...
	  Square square12 = new PropertySquare("เรารักในหลวง",area,100);
	  Square square13 = new PropertySquare("เรารักในหลวง",area,100);
	  Square square14 = new PropertySquare("เรารักในหลวง",area,100);
	  Square square15 = new PropertySquare("เรารักในหลวง7",area,100);*/
	  
	  /*Square square21 = new PropertySquare("เรารักในหลวง1",area,100);
	  Square square20 = new PropertySquare("เรารักในหลวง2",area,100);
	  Square square19 = new PropertySquare("เรารักในหลวง3",area,100);
	  Square square18 = new PropertySquare("เรารักในหลวง4",area,100);
	  Square square17 = new PropertySquare("เรารักในหลวง5",area,100);
	  Square square22 = new GoToJailSquare();*/
